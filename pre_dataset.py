...
#     val_dataset, test_dataset = train_test_split(temp_dataset, test_size=0.5, random_state=seed)
#     train_dataloader = DataLoader(train_dataset, batch_size=16, collate_fn=lambda batch: collate_fn(batch, token, device), shuffle=True, drop_last=True)
#     val_dataloader = DataLoader(val_dataset, batch_size=16, collate_fn=lambda batch: collate_fn(batch, token, device), shuffle=False, drop_last=True)
#     test_dataloader = DataLoader(test_dataset, batch_size=32, collate_fn=lambda batch: collate_fn(batch, token, device), shuffle=False, drop_last=True)
#     return train_dataloader, val_dataloader, test_dataloader